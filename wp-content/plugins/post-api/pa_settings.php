...
if (array_key_exists("CONTEXT_DOCUMENT_ROOT", $_SERVER)) {
	...
	require_once( $_SERVER["CONTEXT_DOCUMENT_ROOT"] . '/wp-includes/load.php' );
	require_once( $_SERVER["CONTEXT_DOCUMENT_ROOT"] . '/wp-admin/includes/file.php' );
	require_once( $_SERVER["CONTEXT_DOCUMENT_ROOT"] . '/wp-admin/includes/media.php' );
} else {
	require_once( $_SERVER["DOCUMENT_ROOT"] . '/wp-config.php' );
	require_once( $_SERVER["DOCUMENT_ROOT"] . '/wp-load.php' );
	require_once( $_SERVER["DOCUMENT_ROOT"] . '/wp-includes/wp-db.php' );
	require_once( $_SERVER["DOCUMENT_ROOT"] . '/wp-includes/pluggable.php' );
	require_once( $_SERVER["DOCUMENT_ROOT"] . '/wp-includes/load.php' );
