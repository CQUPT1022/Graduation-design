		...
		<div class="copyrights">
			<div class="container">
				<div class="row" id="copyright-note">
					<span>
						<?php echo '&copy; '. esc_html(date_i18n(__('Y','publishable-mag'))); ?> <?php bloginfo( 'name' ); ?>	<span class="footer-info-right">
						<?php echo esc_html_e(' | WordPress Theme by', 'publishable-mag') ?> <a rel="designer" href="<?php echo esc_url('https://superbthemes.com/', 'publishable-mag'); ?>"><?php echo esc_html_e(' SuperbThemes.com', 'publishable-mag') ?></a>
					</span>
					<div class="top">
